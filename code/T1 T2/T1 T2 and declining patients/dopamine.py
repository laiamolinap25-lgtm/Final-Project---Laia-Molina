...
for row, mean, df_rec_plot, common, label, color in datasets:
    for col, receptor in enumerate(receptor_cols, start=1):
        ...
        x, y = x[mask], y[mask]
        region_names = common[mask]  # ← nombres de región para el tooltip

        rho, _ = stats.spearmanr(x, y)

        # Scatter con tooltip de región
        ...
        # Actualizar título del subplot con ρ
...
fig.write_html('baseline_t1t2_dopamine_all_patients.html')
fig.show()