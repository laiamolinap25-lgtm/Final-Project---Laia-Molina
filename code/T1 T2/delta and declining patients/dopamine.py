...
delta_sub = pd.concat([
    calc_delta(control_decline, df_control, cols_sub),
    calc_delta(mci_decline,     df_mci,     cols_sub)
])
...
fig.update_layout(
    title='Spearman ρ: Δ FDG (per year) vs Dopaminergic Receptor Density — Declining Patients',
    height=800, width=1200
)

fig.write_html('delta_fdg_DA_declining_patients.html')
fig.show()