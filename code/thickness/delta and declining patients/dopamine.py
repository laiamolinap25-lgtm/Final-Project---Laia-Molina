...
fig.update_layout(
    title='Spearman ρ: Δ Cortical Thickness (per year) vs Cholinergic Receptor Density — Declining Patients',
    height=500, width=1200
)

fig.write_html('delta_thickness_DA_declining_patients.html')
fig.show()